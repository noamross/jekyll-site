...
***If you have filled out the survey before and are back to add classes you have taken recently, please check ONLY the new classes***
...
<script type="text/javascript">
  ...
  function drawVisualization() {
    var wrapper = new google.visualization.ChartWrapper({
      ...
      options: {'title': 'Survey Results (Updated continuously)', 'legend': 'none', 'hAxis.minValue': '0', 'vAxis.textStyle.fontSize': '14'},
      containerId: 'vis_div'
    });
    wrapper.draw()
